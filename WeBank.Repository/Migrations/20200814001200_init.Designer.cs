...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeBank.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("SavedBalance")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("WeBank.Domain.Models.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("WeBank.Domain.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WeBank.Domain.Models.UserRole", b =>
                {
                    b.HasOne("WeBank.Domain.Models.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WeBank.Domain.Models.User", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
